...
<div style="text-align: right; padding: 15px 20px; background: #161b22; border-bottom: 1px solid #30363d;">
    <span style="color: #fff; font-weight: 500; font-size:14px;">Logged in as: <?php echo $_SESSION['username']; ?>!</span>
    <a href="logout.php" style="background: #0022ff; color: white; padding: 6px 14px; border-radius: 6px; text-decoration: none; margin-left: 10px; font-size:13px;">Sign Out</a>
</div>
<?php endif; ?>
...
<section class="projects-section" id="projects">
    <h2 class="section-title">My Projects & Expertise</h2>
    <div class="projects-container">
        <?php
        // Filter elements explicitly assigned to 'Home Page' selection inside dashboard
        $fetch_query = "SELECT * FROM portfolio_items WHERE page_name='Home' AND is_deleted = 0 ORDER BY id DESC";
        $portfolio_data = $conn->query($fetch_query);

        if ($portfolio_data && $portfolio_data->num_rows > 0):
            while($item = $portfolio_data->fetch_assoc()):
                
                // Image assignment fallback architecture
                $img_src = "wordpress.png"; 
                if(!empty($item['image_path']) && file_exists($item['image_path'])){
                    $img_src = $item['image_path'];
                } else {
                    if(strtolower($item['category']) == 'skill') { $img_src = "graphic.png"; }
                    elseif(strtolower($item['category']) == 'service') { $img_src = "marketing.png"; }
                    if(stripos($item['title'], 'django') !== false) { $img_src = "django.png"; }
                    elseif(stripos($item['title'], 'e-commerce') !== false) { $img_src = "ecommerce.png"; }
                    elseif(stripos($item['title'], 'social') !== false) { $img_src = "social.png"; }
                }
        ?>
        ...
        ?>
            <div class="project-card"><img src="wordpress.png" alt="WP"><div class="project-info"><h3>WordPress Web Solutions</h3><p>Custom Business Websites</p></div></div>
            <div class="project-card"><img src="django.png" alt="Django"><div class="project-info"><h3>Django Web Apps</h3><p>Scalable Python Backend</p></div></div>
            <div class="project-card"><img src="graphic.png" alt="Design"><div class="project-info"><h3>Graphic Design Portfolio</h3><p>Branding & Visual Identity</p></div></div>
        <?php endif; ?>
    </div>
</section>
...
<section class="skills-section" id="skills">
    ...
    <div class="skills-container">
        <div class="skill-box">
            <div class="skill-info"><span>WordPress Development</span><span>95%</span></div>
            <div class="progress-line"><span class="wordpress"></span></div>
        </div>
        <div class="skill-box">
            <div class="skill-info"><span>Graphic Designing</span><span>90%</span></div>
            <div class="progress-line"><span class="graphics"></span></div>
        </div>
        <div class="skill-box">
            <div class="skill-info"><span>Digital Marketing</span><span>85%</span></div>
            <div class="progress-line"><span class="marketing"></span></div>
        </div>
        <div class="skill-box">
            <div class="skill-info"><span>Social Media Management</span><span>80%</span></div>
            <div class="progress-line"><span class="social"></span></div>
        </div>
        <div class="skill-box">
            <div class="skill-info"><span>Django / Python</span><span>88%</span></div>
    ...
    <div class="footer-container">
        ...
        <div class="footer-column">
            ...
            <div class="social-wrapper">
                <a href="https://github.com/saimilyas459-rgb" target="_blank" class="social-icon"><i class="fab fa-github"></i></a>
                <a href="https://www.linkedin.com/in/saim-ilyas-61a914385" target="_blank" class="social-icon"><i class="fab fa-linkedin"></i></a>
            </div>
        </div>
    </div>
